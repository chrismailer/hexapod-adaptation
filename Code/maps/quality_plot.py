...
global_performance = np.loadtxt('global_performance.dat')
global_reliability = np.loadtxt('global_reliability.dat')
precision = np.loadtxt('precision.dat')
coverage = np.loadtxt('coverage.dat')
