...
# tripod_gait = [	0.15, 0, 0.06, 0.0, 0.5, # leg 0
# 				0.15, 0, 0.06, 0.5, 0.5, # leg 1
# 				0.15, 0, 0.06, 0.0, 0.5, # leg 2
# 				0.15, 0, 0.06, 0.5, 0.5, # leg 3
# 				0.15, 0, 0.06, 0.0, 0.5, # leg 4
# 				0.15, 0, 0.06, 0.5, 0.5] # leg 5

# radius, offset, step_height, phase, duty_factor
tripod_gait = [	0.15, 0, 0.06, 0.5, 0.5, # leg 0
				0.15, 0, 0.06, 0.0, 0.5, # leg 1
				0.15, 0, 0.06, 0.5, 0.5, # leg 2
				0.15, 0, 0.06, 0.0, 0.5, # leg 3
...
quadruped_gait = [	0.15, 0, 0.06, 0/3, 2/3, # leg 0
					...
					0.15, 0, 0.06, 2/3, 2/3, # leg 2
					0.15, 0, 0.06, 0/3, 2/3, # leg 3
					0.15, 0, 0.06, 1/3, 2/3, # leg 4
					0.15, 0, 0.06, 2/3, 2/3] # leg 5

stationary = [0.17, 0, 0, 0, 0] * 6
