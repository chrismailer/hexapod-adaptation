...
for scenario in range(1,5):
    sim_data_10.append(list(np.loadtxt(f'./10k/trials_{scenario}.dat').flatten()))
    sim_data_20.append(list(np.loadtxt(f'./20k/trials_{scenario}.dat').flatten()))
    sim_data_40.append(list(np.loadtxt(f'./40k/trials_{scenario}.dat').flatten()))
